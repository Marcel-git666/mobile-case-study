...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinGeckoApi")))
@interface SharedCoinGeckoApi : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)getCoinsListWithCompletionHandler:(void (^)(NSArray<SharedCoinDto *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCoinsList(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getTrendingCoinsWithCompletionHandler:(void (^)(NSArray<SharedCoinDto *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getTrendingCoins(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)searchCoinsQuery:(NSString *)query completionHandler:(void (^)(NSArray<SharedCoinDto *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("searchCoins(query:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinDto")))
@interface SharedCoinDto : SharedBase
- (instancetype)initWithId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name image:(NSString *)image currentPrice:(double)currentPrice priceChangePercentage24h:(double)priceChangePercentage24h __attribute__((swift_name("init(id:symbol:name:image:currentPrice:priceChangePercentage24h:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinDtoCompanion *companion __attribute__((swift_name("companion")));
- (SharedCoinDto *)doCopyId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name image:(NSString *)image currentPrice:(double)currentPrice priceChangePercentage24h:(double)priceChangePercentage24h __attribute__((swift_name("doCopy(id:symbol:name:image:currentPrice:priceChangePercentage24h:)")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="current_price")
*/
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="price_change_percentage_24h")
*/
@property (readonly) double priceChangePercentage24h __attribute__((swift_name("priceChangePercentage24h")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinDto.Companion")))
@interface SharedCoinDtoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinDtoCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("CoinRepository")))
@protocol SharedCoinRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCoinsListWithCompletionHandler:(void (^)(NSArray<SharedCoin *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCoinsList(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getFavoriteCoinsWithCompletionHandler:(void (^)(NSArray<SharedCoin *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getFavoriteCoins(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getTrendingCoinsWithCompletionHandler:(void (^)(NSArray<SharedCoin *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getTrendingCoins(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)searchCoinsQuery:(NSString *)query completionHandler:(void (^)(NSArray<SharedCoin *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("searchCoins(query:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)toggleFavoriteCoinId:(NSString *)coinId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("toggleFavorite(coinId:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinRepositoryImpl")))
@interface SharedCoinRepositoryImpl : SharedBase <SharedCoinRepository>
- (instancetype)initWithApi:(SharedCoinGeckoApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
...
@interface SharedCoin : SharedBase
- (instancetype)initWithId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name image:(NSString *)image currentPrice:(double)currentPrice priceChangePercentage24h:(double)priceChangePercentage24h isFavorite:(BOOL)isFavorite __attribute__((swift_name("init(id:symbol:name:image:currentPrice:priceChangePercentage24h:isFavorite:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinCompanion *companion __attribute__((swift_name("companion")));
- (SharedCoin *)doCopyId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name image:(NSString *)image currentPrice:(double)currentPrice priceChangePercentage24h:(double)priceChangePercentage24h isFavorite:(BOOL)isFavorite __attribute__((swift_name("doCopy(id:symbol:name:image:currentPrice:priceChangePercentage24h:isFavorite:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) double currentPrice __attribute__((swift_name("currentPrice")));
...
@interface SharedCoinCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("CoinsState")))
@interface SharedCoinsState : SharedBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinsState.Error")))
@interface SharedCoinsStateError : SharedCoinsState
- (instancetype)initWithMessage:(NSString *)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (SharedCoinsStateError *)doCopyMessage:(NSString *)message __attribute__((swift_name("doCopy(message:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinsState.Loading")))
@interface SharedCoinsStateLoading : SharedCoinsState
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)loading __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinsStateLoading *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinsState.Success")))
@interface SharedCoinsStateSuccess : SharedCoinsState
- (instancetype)initWithTrendingCoins:(NSArray<SharedCoin *> *)trendingCoins favoriteCoins:(NSArray<SharedCoin *> *)favoriteCoins __attribute__((swift_name("init(trendingCoins:favoriteCoins:)"))) __attribute__((objc_designated_initializer));
- (SharedCoinsStateSuccess *)doCopyTrendingCoins:(NSArray<SharedCoin *> *)trendingCoins favoriteCoins:(NSArray<SharedCoin *> *)favoriteCoins __attribute__((swift_name("doCopy(trendingCoins:favoriteCoins:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedCoin *> *favoriteCoins __attribute__((swift_name("favoriteCoins")));
@property (readonly) NSArray<SharedCoin *> *trendingCoins __attribute__((swift_name("trendingCoins")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinsViewModel")))
@interface SharedCoinsViewModel : SharedBase
- (instancetype)initWithRepository:(id<SharedCoinRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
- (void)toggleFavoriteCoinId:(NSString *)coinId __attribute__((swift_name("toggleFavorite(coinId:)")));
...
@property (readonly) NSString *COINGECKO_BASE_URL __attribute__((swift_name("COINGECKO_BASE_URL")));
@property (readonly) NSString *COINS_LIST_ENDPOINT __attribute__((swift_name("COINS_LIST_ENDPOINT")));
@property (readonly) NSString *SEARCH_ENDPOINT __attribute__((swift_name("SEARCH_ENDPOINT")));
@property (readonly) NSString *TRENDING_ENDPOINT __attribute__((swift_name("TRENDING_ENDPOINT")));
@end

@interface SharedCoinDto (Extensions)
- (SharedCoin *)toCoin __attribute__((swift_name("toCoin()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KoinModuleKt")))
@interface SharedKoinModuleKt : SharedBase
+ (SharedKoin_coreModule *)appModule __attribute__((swift_name("appModule()")));
